...
function makeWeapon(def, buildFn) {
  ...
  return { ...def, group, parts, muzzleAnchor,
    ...
    mag: def.magSize, reserve: def.reserveStart, reloading: false, reloadEnd: 0, lastShot: -9,
    cycleT: 0, boltSoundPending: false };
}
const arsenal = [
  ...
  makeWeapon({ name: 'SNIPER "FALCÃO DOURADO"', auto: false, rpm: 48, dmg: 110, pellets: 1, magSize: 5, reserveStart: 20,
    reloadTime: 2.75, spreadHip: 0.024, spreadAds: 0.00035, recoilP: 2.05, recoilY: 0.2, kick: 0.16,
    adsFov: 24, hip: [0.25, -0.23, -0.42], ads: [0, -0.115, -0.2],
    boltAction: true, cycleDuration: 1.05 }, buildDMR),
  makeWeapon({ name: 'BAZUCA "TROVOADA"', auto: false, rpm: 30, dmg: 0, pellets: 1, magSize: 1, reserveStart: 4,
    ...
    adsFov: 60, hip: [0.3, -0.2, -0.42], ads: [0.1, -0.07, -0.34], rocket: true, locked: true,
    rocketSplash: { radius: 9, enemyMax: 180, enemyMin: 20, bossMax: 155,
      extraMax: 170, remoteMax: 150, selfRadius: 7, selfMax: 70 } }, buildBazooka),
  makeWeapon({ name: 'PLASMA "VISITANTE"', auto: true, rpm: 430, dmg: 38, pellets: 1, magSize: 42, reserveStart: 210,
    ...
    adsFov: 58, hip: [0.26, -0.235, -0.48], ads: [0, -0.083, -0.3],
    laser: true, plasma: true, locked: true }, buildPlasma),
  makeWeapon({ name: 'MACHADO "AURORA"', auto: false, rpm: 105, dmg: 46, pellets: 1, magSize: 1, reserveStart: 0,
    reloadTime: 0.8, spreadHip: 0, spreadAds: 0, recoilP: 0.3, recoilY: 0.06, kick: 0.07,
    adsFov: 66, hip: [0.3, -0.25, -0.48], ads: [0.16, -0.19, -0.4],
    melee: true, meleeDuration: 0.52, locked: true }, buildKnife),
  ...
  makeWeapon({ name: 'SNIPER "AGULHA"', auto: false, rpm: 235, dmg: 30, pellets: 1, magSize: 10, reserveStart: 40,
